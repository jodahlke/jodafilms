    ...
    <main className="min-h-screen bg-[var(--background)]">
      ...
      <div className="pt-28 pb-16 px-4 sm:px-8 md:px-12 max-w-4xl mx-auto">
        ...
        <div className="mb-20">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold mb-4">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
            <p className="mb-4 text-gray-300">
              Hinweis gemäß § 36 VSBG: Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.
            </p>
          </section>
        </div>
      </div>
